...
function createFastUI(userConfig) {
  ...
  async function init() {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent("fastui:ready", { detail: { version: "0.1.1" } }));
    } catch (error) {
  ...
  function initFlowbiteWrapper(el, type) {
    initFlowbiteComponents(el);
  }
  const api = {
    version: "0.1.1",
