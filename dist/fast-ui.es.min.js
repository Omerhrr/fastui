...
function registerDirectivesWithAlpine() {
  if (!hasAlpine()) return;
  debugLog();
...
function createFastUI(userConfig) {
  ...
  async function init() {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent("fastui:ready", { detail: { version: "0.1.5" } }));
    } catch (error) {
...
async function loadAlpineScript() {
